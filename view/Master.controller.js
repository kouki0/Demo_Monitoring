sap.ui.define([
	...
	return sap.ui.core.mvc.Controller.extend("monitoring.view.Master", {
		...
		loadDetailView: function() {
			this.getRouter().myNavToWithoutHash({
				...
				targetViewName: "monitoring.view.Detail",
				targetViewType: "XML"
			});
		},
		...
		onSearch: function() {
			...
			if (searchString && searchString.length > 0) {
				filters = [new sap.ui.model.Filter("Lgnum", sap.ui.model.FilterOperator.Contains, searchString)];
			}
			// Update list binding
